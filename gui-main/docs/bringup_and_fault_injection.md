...
2. Run `scripts/bootstrap_real_runtime.sh` to generate development TLS material when absent, re-run the doctor in strict mode, and then launch the vendored xCore runtime.
