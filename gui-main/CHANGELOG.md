...
- Introduced canonical frontend state modules under `ui_frontend/src/state/` and downgraded legacy `store/` and `stores/` paths to compatibility shims, reducing duplicate state abstractions.
