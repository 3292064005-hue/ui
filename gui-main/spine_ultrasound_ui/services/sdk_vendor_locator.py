...
class SdkVendorLocator:
    ...
    Resolution order is intentionally vendor-first: the repository's checked-in
    SDK is the canonical source of truth for this project. Environment variables
    are treated as explicit overrides only.
    """
